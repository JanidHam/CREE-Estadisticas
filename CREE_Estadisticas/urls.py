...
urlpatterns = patterns('',
    ...
    url(r'^encuestas/contestar/(?P<id>\d+)/guardar-encuesta-contestada/$', 'estadisticas.views.guardarContestarEncuesta', name='guardarContestarEncuesta'),
    url(r'^encuestas/guardar-encuesta/$', views.guardarEncuesta, name='guardarEncuesta'),
    url(r'^encuestas/estadisticas/(?P<id>\d+)/$', views.estadisticasEncuesta, name='estadisticasEncuesta'),
    url(r'^encuestas/estadisticas/(?P<id>\d+)/mostrar-estadisticas/$', views.mostrarEstadisticas, name='mostrarEstadisticas'),
